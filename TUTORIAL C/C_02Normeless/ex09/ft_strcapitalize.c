...
/*   Updated: 2021/04/14 05:10:10 by llucusi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strcapitalize(char *str)
{
	...
	while (str[i] != '\0')
	{
		...
		/*	se str[i -1] for MENOR q 'a' OU MAOIR q 'z'
			E str[i -1] for MENOR q 'A' OU MAOIR q 'Z'
			E str[i -1] for MENOR que '0' OU MAIOR q '9;
			E str[i] for letra minuscula
			str[i] vira maiuscula 
		*/
